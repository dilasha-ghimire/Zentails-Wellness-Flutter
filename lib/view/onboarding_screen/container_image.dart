  ...
  return SafeArea(
    child: Container(
      ...
      child: Column(
        ...
        children: [
          const SizedBox(
              height: 30), // Provides spacing above the image widget.
          Container(
          ...
          const SizedBox(
              height: 50), // Adds spacing between the image and the title text.
          Text(
          ...
          Container(
            ...
            child: Text(
              ...
              textAlign: TextAlign.center, // Centers the subtitle horizontally.
              style: const TextStyle(
                fontFamily:
